...
from zeus.optimizer.pipeline_frequency.third_party.megatron_lm.monkey_patch import instrument_megatron
...
def model_provider(pre_process=True, post_process=True) -> Union[GPTModel, megatron.legacy.model.GPTModel]:
    ...
    if not pfo_initialized:
        server_url = getattr(args, "pfo_server_url", "http://127.0.0.1:7787")
        # Here we assume that args.pfo_server_url is set appropriately.
        ...
        server_url=server_url,  # make sure this is provided in args
        job_metadata=str("metada") # or any other string to describe the job
    )
